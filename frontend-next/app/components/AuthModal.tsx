            ...
            <div className="relative w-full max-w-[484px] h-full md:h-auto max-h-[100vh] md:max-h-[92vh] z-10 flex flex-col items-center overflow-y-auto no-scrollbar">
                ...
                >
                    ...
                    <div className="w-full flex flex-col items-center mt-8">
                        ...
                        <div className="w-full h-[48px] px-5 flex items-center justify-center border border-[#cdcdcd] rounded-full hover:bg-gray-50 cursor-pointer transition-colors mb-6 shadow-sm gap-3">
                            ...
                            <div className="text-[14px] font-bold text-gray-900">Continue with Google</div>
                        </div>
