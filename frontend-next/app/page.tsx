...
=======
      {/* 👇 Ajout d'un conteneur avec padding-top pour décaler tout le contenu sous le header fixe */}
      <main> {/* Ajustez si votre header est plus haut (ex: pt-32) */}
        <HeroBanner />
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-6">
                        <div className="flex items-center space-x-2">
                          <img
                            width="30"
                            height="30"
                            src="https://img.icons8.com/ios/50/rice-bowl.png"
                            alt="Prep time"
                          />
                        ...
                        <div className="flex items-center space-x-2">
                          <img
                            width="30"
                            height="30"
                            src="https://img.icons8.com/wired/64/chef-hat.png"
                            alt="Level"
                          />
